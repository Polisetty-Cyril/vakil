...
export const Appbar = () => {
  return (
    <header className="fixed top-0 left-0 w-full h-16 bg-white/70 text-black flex items-center px-[20%] border-b border-border backdrop-blur-sm justify-between">
